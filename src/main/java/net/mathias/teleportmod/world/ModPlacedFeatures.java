...
public class ModPlacedFeatures {
    public static final RegistryKey<PlacedFeature> NETHER_ENERGY_ORE_PLACED_KEY = registerKey("nether_energy_ore_placed");
    ...
    public static RegistryKey<PlacedFeature> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(TeleportMod.MOD_ID, name));
    }
